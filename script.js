...
const chatResponses = {
    intro: {
        message: "Bonjour ! 👋\n\nJe suis l'assistant ScoreMirage. Je peux vous aider à télécharger, installer et utiliser l'extension en quelques minutes.\n\nQue souhaitez-vous faire ?",
        choices: [
            { text: "Télécharger l'extension", next: 'download' },
            { text: "Installation rapide", next: 'installation' },
            { text: "Fonctionnalités clés", next: 'features' },
            { text: "Sécurité & confidentialité", next: 'security' }
        ]
    },
    installation: {
        message: "Installation rapide ⚡\n\nL'installation prend moins de 2 minutes :\n\n**Étape 1 — Télécharger :**\n• Téléchargez l'archive ici : https://www.mediafire.com/file/glahuii3cq270a1/ScoreMirage.zip/file\n• Décompressez le fichier ZIP dans un dossier\n\n**Étape 2 — Installer :**\n• Chrome / Edge / Brave / Opera / Vivaldi : ouvrez chrome://extensions/ → activez \"Mode développeur\" → \"Charger l'extension non empaquetée\" → sélectionnez le dossier\n• Firefox : ouvrez about:debugging → \"Ce Firefox\" → \"Charger un module complémentaire temporaire\" → sélectionnez manifest.json\n\nUne fois installée, l'extension fonctionne immédiatement, sans configuration complexe.",
        choices: [
    ...
    pricing: {
        message: "Gratuit & open-source ✅\n\nScoreMirage est **100% gratuit** et **open-source**.\nAucun abonnement, aucun paiement, aucune limitation.\n\nVous pouvez télécharger l'extension immédiatement et vérifier le code si besoin.\n\nLien direct : https://www.mediafire.com/file/glahuii3cq270a1/ScoreMirage.zip/file",
        choices: [
    ...
    security: {
        message: "Sécurité et confidentialité 🔒\n\nVos données sont **100% sécurisées** avec ScoreMirage :\n\n**Stockage local :**\nToutes vos modifications sont stockées uniquement sur votre appareil via l'API de stockage local de votre navigateur (chrome.storage.local ou browser.storage.local). Aucune donnée n'est jamais envoyée à des serveurs externes.\n\n**Aucune collecte de données :**\nScoreMirage ne collecte aucune information personnelle, ne fait aucun tracking, et ne transmet aucune donnée à l'extérieur. Votre vie privée est respectée.\n\n**Code source ouvert :**\nLe code source est disponible sur GitHub, vous pouvez le vérifier vous-même pour vous assurer qu'il n'y a aucune collecte de données.\n\n**Contrôle total :**\nVous avez un contrôle total sur vos données. Vous pouvez supprimer toutes les modifications à tout moment depuis les paramètres de l'extension.\n\nVos modifications restent privées et sécurisées sur votre appareil uniquement !",
        choices: [
